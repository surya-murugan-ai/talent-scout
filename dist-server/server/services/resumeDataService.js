...
export class ResumeDataService {
     ...
     */
    static async saveResumeData(extractedData, filename, processingTime, confidence) {
        try {
     ...
     */
    static async getResumeDataById(id) {
        try {
            const result = await db
                .select({
                resumeData: resumeData,
     ...
     */
    static async getResumeDataByCandidateId(candidateId) {
        try {
            const result = await db
                .select()
                .from(resumeData)
     ...
     */
    static async deleteResumeData(id) {
        try {
            const result = await db
                .delete(resumeData)
                .where(eq(resumeData.id, id))
     ...
     */
    static async updateCandidateWithLinkedInData(candidateId, linkedInData, source = 'harvestapi') {
        try {
     ...
     */
    static async updateResumeDataWithLinkedIn(resumeDataId, linkedInData, source = 'harvestapi') {
        try {
