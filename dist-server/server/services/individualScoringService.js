...
export class IndividualScoringService {
     ...
     */
    static calculateIndividualScores(candidateData) {
        return {
     ...
     */
    static calculateOpenToWorkScore(candidateData) {
     ...
     */
    static calculateJobStabilityScore(candidateData) {
     ...
     */
    static calculatePlatformEngagementScore(candidateData) {
        let score = 0;
        let factors = 0;
     ...
     */
    static calculateSkillMatchScore(candidateData, jobDescription) {
