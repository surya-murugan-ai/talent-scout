...
export class FileProcessor {
    ...
    static async processExcel(buffer) {
        try {
            ...
            return jsonData
                .map((row) => this.normalizeCandidate(row))
    ...
    static normalizeCandidate(rawData) {
    ...
    static parseEducation(educationString) {
    ...
    static parseWorkHistory(workHistoryString) {
    ...
    static parseCertifications(certificationsString) {
    ...
    static parseYearsOfExperience(experienceString) {
    ...
    static calculateDataQuality(candidate) {
     ...
     */
    static async processResumes(files) {
        try {
     ...
     */
    static async processFile(buffer, filename) {
